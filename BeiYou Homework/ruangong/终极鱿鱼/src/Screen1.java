...
public class Screen1 extends JFrame {
	...
	JLabel Screen = new JLabel("Screen 1",JLabel.CENTER);
	String[] option = { "Adult", "Child","Student","Senior" };
	...
	*/
	public Screen1(int[][] states,String TicketID){
		this.states=states;
		...
		Next.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				dispose();
				Confirm warning=new Confirm(ticketID0, studentID0);
			}
		});
	}
