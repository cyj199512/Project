...
public class ProdManagementPanel extends javax.swing.JPanel {
    ...
    ProdManagementPanel(JPanel containerJPanel, ProductDirectory productDirectory) {
        initComponents();
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        CreateProductJPanel panel = new CreateProductJPanel(containerJPanel, productDirectory);
        containerJPanel.add("CreateProductJPanel", panel);
    ...
    private void btnManageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageActionPerformed
        // TODO add your handling code here:
         ManageProdPanel panel = new ManageProdPanel(containerJPanel, productDirectory);
        containerJPanel.add("ManageProductJPanel", panel);
        CardLayout layout = (CardLayout) containerJPanel.getLayout();
        layout.next(containerJPanel);
